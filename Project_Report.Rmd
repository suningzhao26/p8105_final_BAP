...
*Create two categories of qqi values
*Those aqi values < 50 are categorized as good
*Those aqi values >= 50 are categorized as not good

*H0:The proportion of the individuals who experienced asthma now is the same across two aqi categories.
*H1:The proportion of the individuals who experienced asthma now is not the same across two aqi categories.
```{r}
...
* The AQI's generally remain at similar levels acorss years
...
* NO2 and SO2 contributes the most to Asthma
...
* One way our project can be helpful to the community is that our findings can help the environmental and health department better assess the weight of each of the factors we investigated on and decide how to spend their budget on regulating pollutes and manage AQI qualities to a higher extent. With better AQI, we are able to reduce occurrences of many health problems including, but not limited to, Asthma and heart diseases.