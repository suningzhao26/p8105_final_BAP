...
Due to large file size, the raw datasets obtained from BRFSS were stored on local disk. Resulting survey datasets for each year were stored in "brfss" folder from "data" subdirectory. The combined 10-year brfss files was saved as a dataframe named `brfss_indi`, and it was also written as brfss_indi.csv file, stored in the “data” folder.
