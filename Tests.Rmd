...
#The aqi values < 50 are categorized as good
#The aqi values >= 50 are categorized as not good
#H0:
# The proportion of the individuals who experienced asthma now is the same across two aqi categories.

#H1:
# The proportion of the individuals who experienced asthma now is not the same across two aqi categories.
```{r}
