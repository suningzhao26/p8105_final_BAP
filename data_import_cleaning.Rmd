...
```{r}
daily_ny_2022_co = read_csv("./data/daily_parameter/co/daily_42101_2020.csv") %>% 
  janitor::clean_names() %>% 
  filter(state_name == "New York")
```

```{r}
daily_ny_2022_no2 = read_csv("./data/daily_parameter/no2/daily_42602_2020.csv") %>% 
  janitor::clean_names() %>% 
  filter(state_name == "New York")
```

```{r}
daily_aqi = read_csv("./data/daily_aqi/daily_aqi_by_county_2020.csv")
...
### Daily aqi for each county in New York State from 2011 to 2020.
